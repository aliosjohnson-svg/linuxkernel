...
sed -i -e '1iKBUILD_CFLAGS := $(filter-out -mrecord-mcount,$(KBUILD_CFLAGS))' ${BUILD_DIR}/aic8800d80fdrvpackage/drivers/aic8800/Makefile

cd ${BUILD_DIR}/aic8800d80fdrvpackage
make KSRC=${KERNEL_DIR} M=${BUILD_DIR}/aic8800d80fdrvpackage ARCH=arm64 CROSS_COMPILE=aarch64-linux-gnu- -j$(nproc)
make KSRC=${KERNEL_DIR} M=${BUILD_DIR}/aic8800d80fdrvpackage ARCH=arm64 CROSS_COMPILE=aarch64-linux-gnu- install INSTALL_MOD_PATH=${OUTPUT_DIR}
